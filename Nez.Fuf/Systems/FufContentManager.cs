...
namespace Nez.Fuf.Systems {
    /// <summary>
    /// A ContentManager based on NezContentManager, but using LayeredContentManager as a base.
    /// </summary>
    public class FufContentManager : LayeredContentManager {
        Dictionary<string, Effect> _loadedEffects = new Dictionary<string, Effect>();


        public FufContentManager(IServiceProvider serviceProvider, string rootDirectory) : base(serviceProvider,
            rootDirectory) { }


        public FufContentManager(IServiceProvider serviceProvider) : base(serviceProvider) { }


        public FufContentManager() : base(Core.instance.Services, Core.instance.Content.RootDirectory) { }
